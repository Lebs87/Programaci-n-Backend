...
function loginTemplate() {
    return `<div class="container alert alert-primary text-center" role="alert">
...
function productsTable(products) {
    let htmlToRender = `<table class="table container">
      <thead>
        <tr>
...
function chatMessages(data) {
    ...
    denormalized.data.forEach((element) => {
        htmlChatToRender = htmlChatToRender + `<div>
